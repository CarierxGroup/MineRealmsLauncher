...
namespace MineRealmsLauncher.Controls
{
    ...
    public partial class MainPanelControl : UserControl
    {
        ...
        private ObservableCollection<MineRealmsLauncherCore.Modules.Version> versionList = new ObservableCollection<MineRealmsLauncherCore.Modules.Version>();
        ...
        public async void Refresh()
        {
            try
            {
                ...
                //更新版本列表
                List<MineRealmsLauncherCore.Modules.Version> versions = await App.handler.GetVersionsAsync();
                versionList.Clear();
    ...
    {
        public MineRealmsLauncherCore.Modules.Version LaunchVersion { get; set; }
