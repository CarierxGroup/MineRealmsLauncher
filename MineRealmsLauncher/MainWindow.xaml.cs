...
using MineRealmsLauncherCore;
using MineRealmsLauncherCore.Auth;
using MineRealmsLauncherCore.Modules;
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private async Task LaunchGameFromArgs(Controls.LaunchEventArgs args)
        {
            try
            {
                ...
                {
                    launchSetting.LaunchToServer = new MineRealmsLauncherCore.Modules.Server() { Address = App.config.MainConfig.Server.Address, Port = App.config.MainConfig.Server.Port };
                }
        ...
        {
            var ver = await App.MineRealmsAPIHandler.GetLatestLauncherVersion();
            if (ver != null)
            {
