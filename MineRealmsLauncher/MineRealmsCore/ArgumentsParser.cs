...
namespace MineRealmsLauncherCore
{
    public class ArgumentsParser
    {
        ...
        public string Parse(Modules.LaunchSetting setting)
        {
            ...
            Dictionary<string, string> jvmArgDic = new Dictionary<string, string>()
            {
                ...
                {"${launcher_name}","MineRealmsLauncher5" },
            ...
            Dictionary<string, string> gameArgDic = new Dictionary<string, string>()
            {
                ...
                {"${user_type}",legacy },
                {"${version_type}", string.IsNullOrWhiteSpace(setting.VersionType) ? "MineRealmsLauncher5":setting.VersionType }
            };
