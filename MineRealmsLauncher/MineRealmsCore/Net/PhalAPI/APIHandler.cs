...
namespace MineRealmsLauncherCore.Net.PhalAPI
{
    public class APIHandler
    {
        ...
        public async Task<MineRealmsLauncherVersionResponse> GetLatestLauncherVersion()
        {
            try
            {
                ...
                MineRealmsLauncherVersionListResponse list = listJobj.ToObject<MineRealmsLauncherVersionListResponse>();
        ...
        public async Task RefreshUsingTimesCounter()
        {
            if (!NoTracking)
            {
                try
                {
                    ...
                    args.Add("name", "MineRealmsLauncherUsingTimes");
                    args.Add("value", "1");
