...
namespace MineRealmsLauncherCore.Net.PhalAPI
{
    ...
    public class MineRealmsLauncherVersionListResponse
    {
        [JsonProperty("list")]
        public List<MineRealmsLauncherVersionResponse> List { get; set; }
    ...
    public class MineRealmsLauncherVersionResponse
    {
        /// <summary>
        /// 版本号
        /// </summary>
