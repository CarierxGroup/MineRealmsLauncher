...
namespace MineRealmsLauncher.Windows
{
    ...
    public partial class ErrorWindow : MetroWindow
    {
        ...
        {
            System.Diagnostics.Process.Start("mailto:siso@MineRealms.com");
        }
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/MineRealms");
        }
        ...
        private async void RebootButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await App.MineRealmsAPIHandler.PostLogAsync(MineRealmsLauncherCore.Modules.LogLevel.FATAL, report);
            }
            catch (Exception ex)
            {
        ...
        private string GetReport()
        {
            ...
            strBuilder.AppendLine("========MineRealmsLauncher Error Report========");
