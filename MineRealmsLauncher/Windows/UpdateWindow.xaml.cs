...
using MineRealmsLauncherCore.Net.PhalAPI;
...
namespace MineRealmsLauncher.Windows
{
    ...
    {
        public MineRealmsLauncherVersionResponse VersionResponse { get; set; }
        public UpdateWindow(MineRealmsLauncherVersionResponse response)
        {
            InitializeComponent();
        ...
        private void UpdateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            //else
            //{
            //    string path = string.Format("MineRealmsLauncher-{0}.exe", VersionResponse.Version);
